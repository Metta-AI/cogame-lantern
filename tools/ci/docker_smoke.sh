...
# Substitute: lantern, coworld-lantern, 6.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-lantern:ci)
#   SMOKE_SLUG                 game slug                        (lantern)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/lantern)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/lantern-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-lantern:ci}}"
slug="${SMOKE_SLUG:-lantern}"
